class RollerCoaster extends THREE.Object3D {
  ...
  createCurve() {
    ...
    this.curve = new THREE.CatmullRomCurve3( [
      ...
      new THREE.Vector3( 0, 30, 25 ), new THREE.Vector3( -25, 10, 0 ),
      new THREE.Vector3( 0, 30, 4 ), new THREE.Vector3( -10, 15, 35 ),
      new THREE.Vector3( 14, 40, 40 ), new THREE.Vector3( -10, 27, 10 ),
      new THREE.Vector3( 12, 12, -15 ), new THREE.Vector3( -12, 20, -30 ),
      new THREE.Vector3( -15, 16, 0 ), new THREE.Vector3( -13, 12, 13 ),
      new THREE.Vector3( -4, 10, 11 )
    ] );
    // TubeGeometry(path : Curve, tubularSegments : Integer, radius : Float, radialSegments : Integer, closed : Boolean)
    var geometry = new THREE.TubeGeometry(this.curve, 256, 0.5, 24, true);
